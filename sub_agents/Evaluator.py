...
class Evaluator:
    ...
    def evaluate(self, traj, message):
        ...
        Args:
            ...
            message (str): Original intention of contrastive policy generation
        """
        evaluator_prompt = """
        You are a evaluator that evaluates whether the Policy generator agent produced right code for contrastive policy.
        ...
        You will get a great reward if you correctly filter out the wrongly generated contrastive policy!
        """
