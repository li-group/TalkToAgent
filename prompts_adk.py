...
def get_prompts(prompt):
    ...
    After calling the function, you are going to pass two objects to the explainer:
        1) Resulting list of figures called by function calls
        2) fn_name that has been called
    """
...
def get_fn_description(fn_name:str) -> str:
    """
    Returns function descriptions of given function name.
    Args:
        fn_name (str): XRL function name
    Returns:
        fn_description (str): Corresponding function description
    """
...
def get_figure_description(fn_name:str) -> str:
    """
    Returns figure descriptions of given function name.
    Args:
        fn_name (str): XRL function name
    Returns:
        figure_description (str): Corresponding figure description
    """
