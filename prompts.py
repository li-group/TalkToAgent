...
"""
    ...
    - If XRL visualization are inputted, briefly explain how to interpret ALL GIVEN visualization results.
        Figure description:
        {figure_description}
...
def get_figure_description(fn_name):
    ...
    If SHAP are being used, you will get three plots as results:
    ...
    Make sure to explain all three plots without missing.
    ...
    trajectory_counterfactual_figure_description = """fn_name is trajectory_sensitivity.
    You will get one plot as results:
